...
public class CompareActivity extends BaseActivity {
    ...
    private void populateComparisonResults() {
        ...
        ((TextView) findViewById(R.id.tvPossibleDelivery1))
                .setText("Possible delivery in: " + timeStr1);

        ((TextView) findViewById(R.id.tvPossibleDelivery2))
    ...
    public long createRandomTimer(String productName) {
        ...
        long possibleDeliveryTime =
                currentTime + (randomDays * 24L * 60 * 60 * 1000)
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        Material selectedMaterial =
                (Material) data.getSerializableExtra("selectedMaterial");
